...
interface AutoIconProps extends React.SVGAttributes<SVGElement> {
  colorScheme: ColorScheme;
}

const AutoIconLight: FC<React.SVGAttributes<SVGElement>> = (props) => (
  <AutoIcon colorScheme="light" {...props} />
);
const AutoIconDark: FC<React.SVGAttributes<SVGElement>> = (props) => (
  <AutoIcon colorScheme="dark" {...props} />
);

const AutoIcon: FC<AutoIconProps> = ({ colorScheme, ...props }) => (
  <svg
    {...props}
    viewBox="0 0 20 20"
    version="1.1"
...
export { AutoIconLight, AutoIconDark };
