...
const DSPStatusBadge: FC<PropsWithChildren<DSPStatusBadgeProps>> = ({
  ...
  <div
    className={clsx("dsp-status-badge", {
  ...
  >
    <div className="dsp-status-badge__container">
      <span className="dsp-status-badge__prefix">Status</span>
      <span className="dsp-status-badge__value">{status}</span>
    </div>
  </div>
);
